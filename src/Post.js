    ...
    <div ref={ref} className="post">
      <div className="postleader">
        ...
        <div className="MoreVertIcon">
          <MoreVertIcon onClick={()=> setTriggerForDeleteIcons(!triggerForDeleteIcons)} />
          <div onClick={()=> handleDelete(id)} style={{display: triggerForDeleteIcons ? "block" : "none"}} className="MoreVertical-delete" >
              Delete Post
          </div>
        </div>
      </div>
